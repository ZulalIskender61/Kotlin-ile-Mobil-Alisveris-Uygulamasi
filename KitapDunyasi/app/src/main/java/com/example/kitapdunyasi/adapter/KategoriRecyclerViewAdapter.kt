...
class KategoriRecyclerViewAdapter(val postList: ArrayList<KategoriPost>): RecyclerView.Adapter<KategoriRecyclerViewAdapter.PostHolder>() {
    class PostHolder(itemView : View, private val postList: List<KategoriPost>) : RecyclerView.ViewHolder(itemView){
        private val item: ImageView = itemView.findViewById(R.id.recycler_kitaplik_imageView)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PostHolder {
        ...
        val view = inflater.inflate(R.layout.recycler_kitaplik,parent,false)
        return KategoriRecyclerViewAdapter.PostHolder(view, postList)
    }
    ...
    override fun onBindViewHolder(holder: PostHolder, position: Int) {
        val currentPost = postList[position]
        val kitabinAdiTextView = holder.itemView.findViewById<TextView>(R.id.recycler_kitaplik_kitabinAdi)
        val kitabinFiyatiTextView = holder.itemView.findViewById<TextView>(R.id.recycler_kitaplik_kitabinFiyati)
        val kitabinYazariTextView = holder.itemView.findViewById<TextView>(R.id.recycler_kitaplik_kitabinYazari)
        val kitabinSayfaSayisiTextView = holder.itemView.findViewById<TextView>(R.id.recycler_kitaplik_kitabinSayfaSayisi)
        val imageView = holder.itemView.findViewById<ImageView>(R.id.recycler_kitaplik_imageView)
