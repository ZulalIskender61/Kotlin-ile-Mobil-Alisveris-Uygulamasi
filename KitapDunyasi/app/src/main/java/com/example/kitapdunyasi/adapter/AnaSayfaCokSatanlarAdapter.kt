...
class AnaSayfaCokSatanlarAdapter(val postList: ArrayList<Post>) : RecyclerView.Adapter<AnaSayfaCokSatanlarAdapter.PostHolder>() {
    class PostHolder(itemView : View, private val postList: List<Post>) : RecyclerView.ViewHolder(itemView) {
