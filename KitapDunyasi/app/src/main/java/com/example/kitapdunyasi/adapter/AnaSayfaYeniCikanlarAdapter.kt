...
class AnaSayfaYeniCikanlarAdapter(val postList: ArrayList<Post3>) : RecyclerView.Adapter<AnaSayfaYeniCikanlarAdapter.PostHolder>() {
    class PostHolder(itemView : View, private val postList: List<Post3>) : RecyclerView.ViewHolder(itemView) {
